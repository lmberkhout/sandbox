...
HD_PWD='/home/lmberkhout/src/sandbox/lsfr/lsfr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mylsfr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mylsfr.tcl -notrace
